...
import type { Destination, Media, Tour } from "@/cms-types";
...
function getTourHref(unitData: CardTourData): string {
  return unitData.slug ? `/pe/tours/${unitData.slug}` : "/pe/tours";
}

function getDestinationName(unitData: CardTourData): string {
...
function getPrice(unitData: CardTourData): number {
...
function getDifficulty(unitData: CardTourData): keyof typeof trad {
...
function renderTourImage(unitData: CardTourData, className: string) {
...
function renderIcon(
  media: Tour["iconDifficulty"] | Tour["iconMaxPassengers"] | null | undefined,
  fallbackSrc: string,
  className: string,
) {
  if (isMedia(media)) {
...
function renderDescription(unitData: CardTourData, className: string) {
