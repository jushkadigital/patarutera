...
const PaymentButton: React.FC<PaymentButtonProps> = ({
  ...
  const notReady = !cart || !cart.billing_address || !cart.email;
  ...
  console.log("[Checkout][PaymentButton] render", {
    cartId: cart.id,
  ...
  switch (true) {
    case isStripeLike(resolvedProviderId):
      return (
        <StripePaymentButton
          notReady={notReady}
          cart={cart}
    ...
    case isIzipay(resolvedProviderId):
      return <IzipayPaymentButton cart={cart} data-testid={dataTestId} />;
    case isManual(resolvedProviderId):
      return (
