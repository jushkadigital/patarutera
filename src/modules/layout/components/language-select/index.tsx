...
type ReactCountryFlagCode = React.ComponentProps<
  typeof ReactCountryFlag
>["countryCode"];
              ...
              <span className="txt-compact-small flex items-center gap-x-2">
                {current.countryCode && (
                  <ReactCountryFlag
                    ...
                    countryCode={current.countryCode as ReactCountryFlagCode}
                  />
                )}
                ...
                >
                  {o.countryCode ? (
                    <ReactCountryFlag
                      ...
                      countryCode={o.countryCode as ReactCountryFlagCode}
                    />
                  ) : (
