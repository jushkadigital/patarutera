...
import { Button, clx } from "@medusajs/ui" // Asumiendo que tienes clx o usas template strings
      ...
      <div className="flex flex-col gap-y-2" ref={actionsRef}>
        ...
        {totalItems > 0 && (
          <div className="flex justify-between py-2 font-semibold">
            ...
            <span>{convertToLocale({ amount: estimatedTotal, currency_code: region.currency_code })}</span>
          </div>
        )}

        {<Button
          onClick={handleAddToCart}
          disabled={!product.variants || !!disabled || isAdding || totalItems === 0}
          variant="primary"
